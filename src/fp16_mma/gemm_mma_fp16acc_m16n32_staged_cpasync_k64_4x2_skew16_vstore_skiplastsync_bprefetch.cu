// src/fp16_mma/gemm_mma_fp16acc_m16n32_staged_cpasync_k64_4x2_skew16_vstore_skiplastsync_bprefetch.cu
#include "utils.cuh"
...
__device__ __forceinline__ void mma_16x32_step(
    ...
    ldmatrix_x2_trans(b00, b01, b_addr0);
    ldmatrix_x2_trans(b10, b11, b_addr1);
    ldmatrix_x2_trans(b20, b21, b_addr2);
    ldmatrix_x2_trans(b30, b31, b_addr3);

    mma_m16n8k16(a0, a1, a2, a3, b00, b01, c00, c01, c02, c03);
    mma_m16n8k16(a0, a1, a2, a3, b10, b11, c10, c11, c12, c13);
    mma_m16n8k16(a0, a1, a2, a3, b20, b21, c20, c21, c22, c23);
    mma_m16n8k16(a0, a1, a2, a3, b30, b31, c30, c31, c32, c33);
}
...
__global__ void gemm_mma_fp16acc_m16n32_staged_cpasync_k64_4x2_skew16_vstore_skiplastsync_bprefetch_kernel(
    const half* __restrict__ A,
    const half* __restrict__ B,
...
void launch_gemm_mma_fp16acc_m16n32_staged_cpasync_k64_4x2_skew16_vstore_skiplastsync_bprefetch(
    const half* dA, const half* dB, float* dC,
    int M, int N, int K, cudaStream_t stream) {

    if (M % BLOCK_M != 0 || N % BLOCK_N != 0 || K % BLOCK_K != 0) {
        std::fprintf(stderr,
                     "gemm_mma_fp16acc_m16n32_staged_cpasync_k64_4x2_skew16_vstore_skiplastsync_bprefetch: currently requires "
    ...
    gemm_mma_fp16acc_m16n32_staged_cpasync_k64_4x2_skew16_vstore_skiplastsync_bprefetch_kernel<<<grid, block, 0, stream>>>(
        dA, dB, dC, M, N, K);
